.NumberPicker__wrapper {
  ...
  background: -webkit-linear-gradient(top, rgba(85, 220, 224, 0.05) 0%, transparent 100%);
  background: linear-gradient(to bottom, rgba(85, 220, 224, 0.05) 0%, transparent 100%);
